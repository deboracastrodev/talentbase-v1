...
class TestCandidateRegistrationView:
    ...
    def test_register_candidate_duplicate_email(self):
        ...
        User.objects.create_user(
            email="duplicate@example.com", password="existing123", role="candidate"
        )
...
class TestLoginView:
    ...
    def setup_method(self):
        ...
        self.candidate_user = User.objects.create_user(
            email="candidate@example.com", password="TestPass123!", role="candidate", is_active=True
        )

        self.company_user = User.objects.create_user(
            email="company@example.com", password="TestPass123!", role="company", is_active=True
        )

        self.admin_user = User.objects.create_user(
            email="admin@example.com", password="TestPass123!", role="admin", is_active=True
        )

        self.inactive_user = User.objects.create_user(
            email="inactive@example.com", password="TestPass123!", role="candidate", is_active=False
        )

        self.pending_company = User.objects.create_user(
            email="pending@example.com", password="TestPass123!", role="company", is_active=False
        )
    ...
    def test_login_candidate_success(self):
        ...
        """
        # Arrange
        login_data = {"email": "candidate@example.com", "password": "TestPass123!"}
    ...
    def test_login_company_success(self):
        ...
        """
        # Arrange
        login_data = {"email": "company@example.com", "password": "TestPass123!"}
    ...
    def test_login_invalid_password(self):
        ...
        """
        # Arrange
        login_data = {"email": "candidate@example.com", "password": "WrongPassword123!"}
    ...
    def test_login_pending_company(self):
        ...
        """
        # Arrange
        login_data = {"email": "pending@example.com", "password": "TestPass123!"}
    ...
    def test_login_missing_password(self):
        ...
        """
        # Arrange
        login_data = {"email": "candidate@example.com"}
    ...
    def test_login_case_insensitive_email(self):
        ...
        """
        # Arrange
        login_data = {"email": "CANDIDATE@EXAMPLE.COM", "password": "TestPass123!"}  # Uppercase
