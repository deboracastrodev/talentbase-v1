...
class TestGenerateShareTokenEndpoint:
    ...
    def test_generate_token_ownership_check(self, api_client, complete_profile, other_candidate_user):
...
class TestToggleSharingEndpoint:
    ...
    def test_toggle_sharing_ownership_check(self, api_client, complete_profile, other_candidate_user):
    ...
    def test_toggle_sharing_missing_enabled_field(self, api_client, complete_profile, candidate_user):
...
class TestPublicEndpointsIntegration:
    ...
    @patch('candidates.services.sharing.send_email_task')
    def test_complete_public_flow(self, mock_email, api_client, candidate_user, profile_with_experiences):
