        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold">
              Como funciona a TalentBase?
            </h2>
            <h3 className="text-2xl font-semibold text-gray-600">
              1. Preencha seu perfil
            </h3>
            <p className="text-lg text-gray-600">
              Comece criando seu perfil completo. Compartilhe suas experiências,
              habilidades e aspirações profissionais. Quanto mais detalhado,
              melhor a IA pode trabalhar para você.
            </p>
          </div>
          ...
          <div className="animate-fade-in pointer-events-none relative">
            ...
            <Card variant="elevated" padding="lg" className="bg-gray-900 border-none shadow-xl relative">
              <div className="space-y-6">
