 ...
 *
 * Enhanced FormField specifically for auth forms that combines:
...
export interface AuthFormFieldProps extends Omit<InputProps, 'variant'> {
  label: ReactNode;
  error?: string;
  helperText?: string;
  showSuccess?: boolean;
...
/**
 * Form field optimized for authentication pages
 *
 * @example
 * <AuthFormField
 *   id="email"
